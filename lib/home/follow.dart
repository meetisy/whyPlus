              ...
              new Container(
                child: new Row(
                  children: <Widget>[
                    ...
                    new Text("  " + article.user + " " + article.action + " · " + article.time, style: new TextStyle(color: Colors.black))
                  ],
                ),
              ...
              new Container(
                child: new Row(
                  children: <Widget>[
                    ...
                    new PopupMenuButton(
                        icon: new Icon(Icons.linear_scale, color: Colors.black,),
            ...
            children: <Widget>[
              new Container(
                child: new Row(
                  children: <Widget>[
                    ...
                    new Text("  对啊网", style: new TextStyle(color: Colors.black))
                  ],
                ),
                padding: const EdgeInsets.only(top: 10.0),
              ),
              ...
              new Container(
                child: new Row(
                  children: <Widget>[
                    new Container(
                        child: new Text("广告", style: new TextStyle(fontSize: 10.0, color: Colors.black)),
                    ...
                    new Expanded(
                        child: new Text("  查看详情", style: new TextStyle(color: Colors.black))
                    ),
                    new Icon(Icons.clear, color: Colors.black)
                  ],
                ),
