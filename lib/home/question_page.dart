            ...
            body: new SingleChildScrollView(
              child: new Column(
                children: <Widget>[
                      ...
                      children: <Widget>[
                        new Container(
                            child: new TextButton(
                                onPressed: (){}, child: new Text("物理学",style: new TextStyle(color: Colors.black),)),
                            margin: const EdgeInsets.only(right: 8.0)
                        ),
                        new Container(
                            child: new TextButton(onPressed: (){}, child: new Text("三体(书籍)",style: new TextStyle(color: Colors.black))),
                            margin: const EdgeInsets.only(right: 8.0)
                        ),
                        new Container(
                          child: new TextButton(onPressed: (){}, child: new Text("脑洞(网络用语)",style: new TextStyle(color: Colors.black))),
                        )
                      ],
                    ),
                  ...
                  new Container(
                      child: new Text("《三体》里的水滴有可能被制造出来吗?", style: new TextStyle(fontWeight: FontWeight.bold, fontSize: 18.0, height: 1.3, color: Colors.black)),
                  ...
                  new Container(
                    ...
                    child: new Row(
                      children: <Widget>[
                        new Expanded(
                          child: new Container(
                            child: new Text("173个回答", style: new TextStyle(color: Colors.black)),
                            ...
                            child: new PopupMenuButton(
                              ...
                              child: new Container(
                                child: new Row(
                                  ...
                                  children: <Widget>[
                                    new Text("按质量排序", style: new TextStyle(color: Colors.black)),
                                    new Icon(Icons.keyboard_arrow_down, color: Colors.black)
                                  ],
                                ),
                              ),
                            ),
                          ...
                          children: <Widget>[
                            new Container(
                              child: new Row(
                                children: <Widget>[
                                  ...
                                  new Text(" 游牧由", style: new TextStyle(color: Colors.black))
                                ],
                              ),
                            ...
                            new Container(
                              child: new Row(
                                children: <Widget>[
                                  new Expanded(
                                      child: new Text("1K 赞同 · 262 评论 · 10 天前", style: new TextStyle(color: Colors.black))
                                  )
                                ],
                              ),
